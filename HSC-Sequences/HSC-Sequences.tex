...
\makeatother
\newcommand{\HSCBookletHeaderTitle}{Sequences}
...
\HSCMattePagePlain{HSC Mathematics Extension 1}{Sequences and Series}{Vu Hung Nguyen}
...
\subsection{Appendix E: Discrete Calculus and the Difference Operator}
\input{problems/appendix-e-diff-operator}
