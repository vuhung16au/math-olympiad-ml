...
\begin{definition}[Distance between two points in $\mathbb{R}^2$]
...
\begin{example}[Euclidean distance on a plane]
...
\begin{definition}[Haversine formula]
Let two points on a sphere of radius $R$ have latitudes $\phi_1,\phi_2$ and longitude difference $\Delta\lambda = \lambda_2-\lambda_1$. Define the haversine $\operatorname{hav}(\theta)=\sin^2(\tfrac{\theta}{2})$. The central angle $\Delta\sigma$ satisfies
\[
\operatorname{hav}(\Delta\sigma)
\;=\; \operatorname{hav}(\phi_2-\phi_1)
\;+
\cos\phi_1\cos\phi_2\,\operatorname{hav}(\Delta\lambda).
\]
Equivalently,
\[
\Delta\sigma
\;=\; 2\,\arcsin\!\Bigg(\sqrt{\sin^2\!\frac{\phi_2-\phi_1}{2}
\;+
\cos\phi_1\cos\phi_2\,\sin^2\!\frac{\Delta\lambda}{2}}\;\Bigg),
\]
and the great-circle distance is
\[
d \;=\; R\,\Delta\sigma
\;=\; 2R\,\arcsin\!\Bigg(\sqrt{\sin^2\!\frac{\phi_2-\phi_1}{2}
\;+
\cos\phi_1\cos\phi_2\,\sin^2\!\frac{\Delta\lambda}{2}}\;\Bigg).
\]
\end{definition}
...
\begin{example}[Sphere distance on the equator]
...
\begin{example}[Real-World: Sydney to New York]
...
\begin{example}[Approximate distance on a torus]
