...
Imagine standing on Earth's surface. To you, the ground appears flat—you can use a local map as if you were on a plane. Yet we know Earth is a sphere. This intuition—that curved spaces look flat when you zoom in—is the essence of a \textbf{manifold}.
...
This book assumes:
\begin{itemize}
\item \textbf{Basic calculus}: Understanding of derivatives and integrals
\item \textbf{Linear algebra basics}: Familiarity with vectors and matrices
\item \textbf{Coordinate systems}: Comfort with Cartesian and polar coordinates
\item \textbf{No prior knowledge} of differential geometry, manifolds, or advanced topology required
\end{itemize}

The mathematical level is kept accessible, with intuitive explanations accompanying formal definitions.
