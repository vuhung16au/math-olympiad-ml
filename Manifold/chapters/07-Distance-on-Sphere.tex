...
\textbf{Example}: If $\phi_1 = 30^\circ$ and $\phi_2 = 60^\circ$ on the same meridian, with $R = 6371$ km:
\[
...
\textbf{Example}: At latitude $60^\circ$ ($\phi = \pi/3$), the effective radius is $R\cos(\pi/3) = R/2$. So a longitude difference of $1^\circ$ corresponds to a distance of approximately $R \cdot \frac{1}{2} \cdot \frac{\pi}{180} \approx 55.6$ km, compared to about $111$ km at the equator.
...
\textbf{Example}: Two points near the North Pole at $89^\circ$ N, with longitudes $0^\circ$ and $180^\circ$. The great circle distance is approximately $2R \times (90^\circ - 89^\circ) = 2R \times \frac{\pi}{180} \approx 222$ km, which is much smaller than the distance along the parallel ($\pi R \approx 20,015$ km).
...
\textbf{Example}: For two points 10 km apart at latitude $45^\circ$, the flat Earth approximation gives results accurate to within a few meters.
...
\textbf{Example}: If $\cos\theta = -0.9999999999$ (due to rounding), then $\theta = \arccos(-0.9999999999) \approx 1.414 \times 10^{-5}$ radians, but the true value might be slightly different, leading to distance errors.
