...
\textbf{Example}: If $p = 0$ and $r = 2$, then $B_2(0) = (-2, 2)$ is the open interval from $-2$ to $2$, excluding the endpoints.
...
\textbf{Example}: The unit disk centered at the origin is $B_1(\mathbf{0}) = \{(x,y) : x^2 + y^2 < 1\}$.
...
\textbf{Example}: The unit ball centered at the origin is $B_1(\mathbf{0}) = \{(x,y,z) : x^2 + y^2 + z^2 < 1\}$.
...
\textbf{Example}: In the open interval $(-2, 2)$, the distance between $p = -1$ and $q = 1.5$ is:
\[
d(-1, 1.5) = |1.5 - (-1)| = 2.5
\]
...
\textbf{Example}: In the unit disk centered at the origin, for points $\mathbf{p} = (0.3, 0.4)$ and $\mathbf{q} = (0.7, 0.2)$:
\[
...
\textbf{Example}: In the unit ball, for points $\mathbf{p} = (0.5, 0.5, 0.5)$ and $\mathbf{q} = (0.8, 0.3, 0.6)$:
\[
