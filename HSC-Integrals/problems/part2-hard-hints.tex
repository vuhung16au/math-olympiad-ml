...
\vspace{0.5cm}
\rotatebox{180}{\parbox{\textwidth}{\small \textbf{Hint:} \textbf{Part (i):} This is a standard transformation. Calculate $dx$ carefully and update limits. The term $1-x$ becomes $\frac{1}{1+u}$.\\
...
\vspace{0.5cm}
\rotatebox{180}{\parbox{\textwidth}{\small \textbf{Hint:} Apply integration by parts to $\int_0^1 \ln(1+x)\,dx$ with $u=\ln(1+x)$ and $dv=dx$. Then $du=\frac{1}{1+x}\,dx$ and $v=x$, giving
\[
