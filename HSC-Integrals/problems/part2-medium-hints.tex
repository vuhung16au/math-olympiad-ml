% Part 2: Medium Problems (hints only - upside-down format)
% Students attempt first, then rotate page 180° to read hint

% =============================================================================
% PROBLEM 1: Integration by parts twice
% =============================================================================
\begin{problem}[Integration by parts twice]
Evaluate $\displaystyle \int x^2 e^x \, dx$
\end{problem}

\begin{hint}
Apply by parts twice. First: $u_1 = x^2$, $dv_1 = e^x dx$. Second: $u_2 = 2x$, $dv_2 = e^x dx$. Answer: $e^x(x^2 - 2x + 2) + C$.
\end{hint}
...
% =============================================================================
\begin{problem}[Partial fractions with repeated factor]
Find $\displaystyle \int \frac{2x + 3}{(x-1)^2} \, dx$
\end{problem}

\begin{hint}
$\frac{2x+3}{(x-1)^2} = \frac{A}{x-1} + \frac{B}{(x-1)^2}$. Solving: $A=2$, $B=5$. Answer: $2\ln|x-1| - \frac{5}{x-1} + C$.
\end{hint}
...
% =============================================================================
\begin{problem}[Substitution + completing square]
Evaluate $\displaystyle \int \frac{1}{\sqrt{6x - x^2}} \, dx$
\end{problem}

\begin{hint}
Complete square: $6x - x^2 = 9 - (x-3)^2$. Let $u = x-3$. Answer: $\arcsin\left(\frac{x-3}{3}\right) + C$.
\end{hint}
...
% =============================================================================
\begin{problem}[King's property with trig]
Evaluate $\displaystyle \int_0^{\pi/2} \frac{x}{\sin x + \cos x} \, dx$
\end{problem}

\begin{hint}
Let $I = \int_0^{\pi/2} \frac{x}{\sin x + \cos x}dx$. King's: $I = \int_0^{\pi/2} \frac{\pi/2 - x}{\cos x + \sin x}dx$. Add: $2I = \frac{\pi}{2}\int_0^{\pi/2}\frac{1}{\sin x + \cos x}dx$. Use $t = \tan(x/2)$.
\end{hint}
...
% =============================================================================
\begin{problem}[Trig substitution for $\sqrt{a^2 - x^2}$]
Find $\displaystyle \int \sqrt{16 - x^2} \, dx$
\end{problem}

\begin{hint}
Let $x = 4\sin\theta$, $dx = 4\cos\theta \, d\theta$. Then $\sqrt{16-x^2} = 4\cos\theta$. Answer: $8\arcsin(x/4) + \frac{x\sqrt{16-x^2}}{2} + C$.
\end{hint}
...
% =============================================================================
\begin{problem}[Reduction formula - powers of sin]
Derive and use: If $I_n = \displaystyle \int_0^{\pi/2} \sin^n x \, dx$, find $I_4$
\end{problem}

\begin{hint}
By parts: $I_n = \frac{n-1}{n}I_{n-2}$. Calculate: $I_0 = \frac{\pi}{2}$, $I_2 = \frac{\pi}{4}$, $I_4 = \frac{3}{4} \cdot \frac{\pi}{4} = \frac{3\pi}{16}$.
\end{hint}
...
% =============================================================================
\begin{problem}[Partial fractions with quadratic]
Evaluate $\displaystyle \int \frac{x^2 + 11}{(x-1)(x^2 + 1)} \, dx$
\end{problem}

\begin{hint}
$\frac{x^2+11}{(x-1)(x^2+1)} = \frac{A}{x-1} + \frac{Bx+C}{x^2+1}$. Solve: $A=6$, $B=-6$, $C=5$. Answer: $6\ln|x-1| - 3\ln(x^2+1) + 5\arctan x + C$.
\end{hint}
...
% =============================================================================
\begin{problem}[Integration by parts - ln]
Find $\displaystyle \int x^2 \ln x \, dx$
\end{problem}

\begin{hint}
LIATE: $u = \ln x$, $dv = x^2 dx$. Then $v = \frac{x^3}{3}$. Answer: $\frac{x^3 \ln x}{3} - \frac{x^3}{9} + C = \frac{x^3}{9}(3\ln x - 1) + C$.
\end{hint}
...
% =============================================================================
\begin{problem}[Definite integral with symmetry]
Evaluate $\displaystyle \int_{-1}^{1} \frac{x^2}{1 + e^x} \, dx$
\end{problem}

\begin{hint}
Let $I = \int_{-1}^{1} \frac{x^2}{1+e^x}dx$. King's property: $I = \int_{-1}^{1} \frac{x^2 e^x}{1+e^x}dx$. Add: $2I = \int_{-1}^{1} x^2 dx = \frac{2}{3}$, so $I = \frac{1}{3}$.
\end{hint}
...
% =============================================================================
\begin{problem}[Trig identity + substitution]
Evaluate $\displaystyle \int \sin^4 x \, dx$
\end{problem}

\begin{hint}
Use $\sin^2 x = \frac{1-\cos 2x}{2}$. Then $\sin^4 x = \left(\frac{1-\cos 2x}{2}\right)^2 = \frac{1 - 2\cos 2x + \cos^2 2x}{4}$. Use $\cos^2 2x = \frac{1+\cos 4x}{2}$.
\end{hint}
...
% =============================================================================
\begin{problem}[Volume of revolution]
Find the volume when the region bounded by $y = \sqrt{x}$, $y = 0$, $x = 4$ is rotated about the $x$-axis.
\end{problem}

\begin{hint}
$V = \pi\int_0^4 (\sqrt{x})^2 dx = \pi\int_0^4 x \, dx = \pi \cdot \frac{16}{2} = 8\pi$ cubic units.
\end{hint}
...
% =============================================================================
\begin{problem}[t-formula application]
Evaluate $\displaystyle \int_0^{\pi/2} \frac{1}{3 + 5\cos x} \, dx$
\end{problem}

\begin{hint}
Let $t = \tan(x/2)$. Then $\cos x = \frac{1-t^2}{1+t^2}$, $dx = \frac{2}{1+t^2}dt$. Limits: $t=0$ to $t=1$. Answer: $\frac{\ln 3}{4}$.
\end{hint}
...
% =============================================================================
\begin{problem}[Particle motion with integration]
A particle moves with velocity $v = 2t - 3$ m/s. If $s(0) = 5$m, find $s(4)$.
\end{problem}

\begin{hint}
$s(t) = \int v \, dt = t^2 - 3t + C$. Use $s(0)=5$: $C=5$. Then $s(4) = 16 - 12 + 5 = 9$m.
\end{hint}
...
% =============================================================================
\begin{problem}[Substitution creating ln + arctan]
Find $\displaystyle \int \frac{3x + 5}{x^2 + 4} \, dx$
\end{problem}

\begin{hint}
Split: $\frac{3x}{x^2+4} + \frac{5}{x^2+4}$. First gives $\frac{3}{2}\ln(x^2+4)$, second gives $\frac{5}{2}\arctan(x/2)$. Answer: $\frac{3}{2}\ln(x^2+4) + \frac{5}{2}\arctan(x/2) + C$.
\end{hint}
...
\begin{hint}
Consider $\int e^x e^{ix}dx = \int e^{(1+i)x}dx = \frac{e^{(1+i)x}}{1+i}$. Multiply by $\frac{1-i}{1-i}$, take real part. Answer: $\frac{e^x(\cos x + \sin x)}{2} + C$.
\end{hint}
...
\begin{hint}
\textbf{Part (i):} Recall that the domain of integration changes from $x \in [0,1]$ to $\theta \in [0, \frac{\pi}{2}]$. Don't forget to calculate $dx$ in terms of $d\theta$. The integrand should simplify to a constant.\\
