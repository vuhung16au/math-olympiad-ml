...
\subsubsection*{Example 1: $\boldsymbol{y'=y,\; y(0)=1}$}
...
\subsubsection*{Example 2: $\boldsymbol{y'=x+y,\; y(0)=1}$}
We have
\[
y'(0)=0+y(0)=1.
\]
...
\]
which matches the exact solution obtained by more advanced methods.
