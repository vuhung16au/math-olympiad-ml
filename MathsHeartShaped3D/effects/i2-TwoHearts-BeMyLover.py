"""
Effect I2-TwoHearts-BeMyLover: Two Hearts - Dual heart visualization with audio synchronization
1st heart syncs with beats, 2nd heart syncs with tempo
Customized for BeMyLover music
"""
...
class EffectI2TwoHeartsBeMyLover(BaseEffect):
    """Two Hearts: Dual heart visualization with beat and tempo synchronization for BeMyLover."""
...
# Register the effect
register_effect('I2-TwoHearts-BeMyLover', EffectI2TwoHeartsBeMyLover)
