...
VISUALISE_OUTPUT="$PROJECT_ROOT/outputs/i2_visualise.mp4"
SYNCED_VIDEO="$PROJECT_ROOT/outputs/i2_synced.mp4"
FINAL_OUTPUT="$PROJECT_ROOT/outputs/i2-FiveHearts.mp4"
...
echo "============================================================"
echo "I2 Five Hearts Builder (bash)"
