...
AUDIO_FILE="$PROJECT_ROOT/inputs/Katyusha.mp3"
FEATURES_FILE="${AUDIO_FILE%.mp3}_features.json"
VISUALISE_OUTPUT="$PROJECT_ROOT/outputs/i2-TwoHearts-Katyusha_visualise.mp4"
SYNCED_VIDEO="$PROJECT_ROOT/outputs/i2-TwoHearts-Katyusha_synced.mp4"
FINAL_OUTPUT="$PROJECT_ROOT/outputs/i2-TwoHearts-Katyusha.mp4"
...
echo "============================================================"
echo "I2 Two Hearts Katyusha Builder (bash)"
