...
AUDIO_FILE="$PROJECT_ROOT/inputs/BeMyLover.mp3"
FEATURES_FILE="${AUDIO_FILE%.mp3}_features.json"
VISUALISE_OUTPUT="$PROJECT_ROOT/outputs/i2-TwoHearts-BeMyLover_visualise.mp4"
SYNCED_VIDEO="$PROJECT_ROOT/outputs/i2-TwoHearts-BeMyLover_synced.mp4"
FINAL_OUTPUT="$PROJECT_ROOT/outputs/i2-TwoHearts-BeMyLover.mp4"
...
echo "============================================================"
echo "I2 Two Hearts BeMyLover Builder (bash)"
