...
AUDIO_FILE="$PROJECT_ROOT/inputs/EminemLoseYourself.mp3"
FEATURES_FILE="${AUDIO_FILE%.mp3}_features.json"
SYNCED_VIDEO="$PROJECT_ROOT/outputs/i3_EminemLoseYourself_video.mp4"
FINAL_OUTPUT="$PROJECT_ROOT/outputs/EminemLoseYourself.mp4"
...
echo "============================================================"
echo "I3 Eminem Lose Yourself Builder"
