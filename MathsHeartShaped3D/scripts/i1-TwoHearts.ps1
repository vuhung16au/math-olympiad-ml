# Build Script for I1 Effect: Two Hearts - Dual heart visualization with audio synchronization
...
Write-Section "I1 Effect Builder: Two Hearts - Dual Heart Visualization"
...
Write-Host "  • Camera Modes: Dual-frame, focus modes, orbital motion" -ForegroundColor White
...
Write-Section "Step 2: Generating Heart Animation with I1 Effect"
...
$outputVideo = "outputs/i1_${audioFileName}_${Resolution}_video.mp4"

Write-Info "Generating video with I1 effect..."
Write-Host "  Output: $outputVideo" -ForegroundColor White
Write-Host "  Effect: I1 (Two Hearts - Dual Heart Visualization)" -ForegroundColor White
Write-Host "  Resolution: $Resolution" -ForegroundColor White
Write-Host "  Density: $Density" -ForegroundColor White
Write-Host "  FPS: $FPS" -ForegroundColor White
Write-Host "  Bitrate: $Bitrate kbps" -ForegroundColor White
...
Write-Host "  Note: Dual hearts require more processing time" -ForegroundColor Yellow
Write-Host ""
...
$finalOutput = "outputs/i1_${audioFileName}_${Resolution}_video+audio.mp4"
...
Write-Success "I1 Two Hearts animation with audio synchronization is ready!"
Write-Host ""
...
Write-Host ""
Write-Success "Ready to use! 🎥❤️❤️🎵"
Write-Host ""
