# Build Script for I2 Effect: Five Hearts - Multi-heart visualization with comprehensive audio synchronization
# Automates the complete workflow: audio analysis -> video generation -> audio combination

param(
    [string]$AudioFile = "inputs/Trend-Music-Music-Music-x4.mp3",
...
Write-Section "I2 Effect Builder: Five Hearts - Comprehensive Audio Feature Synchronization"
...
Write-Host "  • 1st Heart: Beat-synchronized, magma colormap, position (0,0,0)" -ForegroundColor White
Write-Host "  • 2nd Heart: Tempo-synchronized, YlOrRd colormap, position (25,0,0)" -ForegroundColor White
Write-Host "  • 3rd Heart: Loudness-synchronized, Blues colormap, position (0,20,0)" -ForegroundColor White
Write-Host "  • 4th Heart: Bass-synchronized, Greens colormap, position (0,0,25)" -ForegroundColor White
Write-Host "  • 5th Heart: Onset-synchronized, Purples colormap, position (-25,0,0)" -ForegroundColor White
Write-Host "  • Camera Modes: Multi-heart frame, individual focus, orbital motion" -ForegroundColor White
Write-Host ""
...
Write-Section "Step 2: Generating Heart Animation with I2 Effect"
...
$outputVideo = "outputs/i2_${audioFileName}_${Resolution}_video.mp4"

Write-Info "Generating video with I2 effect..."
Write-Host "  Output: $outputVideo" -ForegroundColor White
Write-Host "  Effect: I2 (Five Hearts - Comprehensive Audio Feature Synchronization)" -ForegroundColor White
Write-Host "  Resolution: $Resolution" -ForegroundColor White
Write-Host "  Density: $Density" -ForegroundColor White
Write-Host "  FPS: $FPS" -ForegroundColor White
Write-Host "  Bitrate: $Bitrate kbps" -ForegroundColor White
...
Write-Host "  Note: Five hearts require significantly more processing time" -ForegroundColor Yellow
Write-Host ""
...
$finalOutput = "outputs/i2_${audioFileName}_${Resolution}_video+audio.mp4"
...
Write-Success "I2 Five Hearts animation with comprehensive audio synchronization is ready!"
Write-Host ""
...
Write-Host "  • Effect: I2 (Five Hearts - Comprehensive Audio Feature Synchronization)" -ForegroundColor White
Write-Host "  • 1st Heart: Beat-synchronized, magma colormap" -ForegroundColor White
Write-Host "  • 2nd Heart: Tempo-synchronized, YlOrRd colormap" -ForegroundColor White
Write-Host "  • 3rd Heart: Loudness-synchronized, Blues colormap" -ForegroundColor White
Write-Host "  • 4th Heart: Bass-synchronized, Greens colormap" -ForegroundColor White
Write-Host "  • 5th Heart: Onset-synchronized, Purples colormap" -ForegroundColor White
Write-Host ""
Write-Success "Ready to use! 🎥❤️❤️❤️❤️❤️🎵"
Write-Host ""
