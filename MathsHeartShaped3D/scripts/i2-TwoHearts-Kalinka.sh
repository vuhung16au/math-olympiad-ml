...
AUDIO_FILE="$PROJECT_ROOT/inputs/Kalinka.mp3"
FEATURES_FILE="${AUDIO_FILE%.mp3}_features.json"
VISUALISE_OUTPUT="$PROJECT_ROOT/outputs/i2-TwoHearts-Kalinka_visualise.mp4"
SYNCED_VIDEO="$PROJECT_ROOT/outputs/i2-TwoHearts-Kalinka_synced.mp4"
FINAL_OUTPUT="$PROJECT_ROOT/outputs/i2-TwoHearts-Kalinka.mp4"
...
echo "============================================================"
echo "I2 Two Hearts Kalinka Builder (bash)"
