...
\begin{dl101box}{Problem 35}
Let
\[
A_n = \int_{0}^{\frac{\pi}{2}} \cos^{2n} x \, dx \quad \text{and} \quad B_n = \int_{0}^{\frac{\pi}{2}} x^2 \cos^{2n} x \, dx,
\]
where $n$ is an integer, $n \ge 0$. (Note that $A_n > 0$, $B_n > 0$.)

\begin{enumerate}
    \item[(a)] Show that $n A_n = \frac{2n-1}{2} A_{n-1}$ for $n \ge 1$.
    ...
    \]
    \item[(e)] Show that $\displaystyle \sum_{k=1}^{n} \frac{1}{k^2} = \frac{\pi^2}{6} - 2 \frac{B_n}{A_n}$.
