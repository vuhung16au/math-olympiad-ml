...
Check: $|1| = |i| = |-i| = 1$ ✓, $1 + i + (-i) = 1$ ✓, $1 \cdot i \cdot (-i) = 1$ ✓.
...
\begin{solution}
\textbf{Base case ($n = 2$):} LHS $= \frac{1}{4} = 0.25$, RHS $= \frac{1}{2} = 0.5$. So $0.25 < 0.5$ ✓
...
So we need: $k^3 + k^2 - k - 1 < k^3 + k^2 - k$, which is $-1 < 0$ ✓
