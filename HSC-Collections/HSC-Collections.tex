...
\makeatother
\newcommand{\HSCBookletHeaderTitle}{Collection of Hard Problems}
...
\HSCMattePagePlain{HSC Mathematics Extension 2}{Collection of Hard Problems}{Vu Hung Nguyen}
...
\vspace{1em}
\normalfont James Joseph Sylvester
\end{center}
\vspace*{\fill}
