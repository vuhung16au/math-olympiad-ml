...
A minimal feed‑forward network: inputs, a hidden layer, and an output. The earliest computational models of neural activity \cite{mcculloch1943logical} and the perceptron \cite{rosenblatt1958perceptron} laid groundwork for these architectures.
