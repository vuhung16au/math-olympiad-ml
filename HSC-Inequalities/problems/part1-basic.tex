...
\begin{problem}[AM-GM with Non-Negative Reals]
...
\begin{problem}[Logarithmic Inequalities and Euler's Number]
Explain why 
\[
...
\begin{takeaways}
    ...
    \item When you see $e$, think of logarithmic functions and integrals of $\frac{1}{x}$.

\end{takeaways}

\begin{problem}[Squared Terms Inequality]
...
\begin{problem}[Cauchy-Schwarz Inequality Application]
