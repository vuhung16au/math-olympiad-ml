...
\begin{itemize}[leftmargin=*]
  \item \textbf{Part 1 (20 problems):} Detailed step-by-step solutions showing complete reasoning, algebraic manipulation, and justification of each step. Each solution is designed to fit within one page, modeling clear and concise proof writing.
...
\subsection*{Hard Problems (9 problems)}
