% Part 2 Problem 17 (Medium): Divisibility by 9 iff sum of digits divisible by 9
% Source: samples/21.tex (moved from former Part 2 Problem 08 slot)
% Technique: Direct Proof (Biconditional)
% Topic: Divisibility Rules/Modular Arithmetic

\begin{problem}[Divisibility by 9 via Digit Sum]
...
\item Reconstruct the full proof from the hint and the solution outline, and justify every transformation explicitly.
\item Check edge cases and verify where each assumption is used in the argument.
\end{itemize}
\end{takeaways}
