...
\author{Vu Hung Nguyen, \href{mailto:vuhung16plus@gmail.com}{vuhung16plus@gmail.com}}
...
Let $M_n = \min(X_1, \ldots, X_n)$ for i.i.d. $X_i \sim \text{Unif}(0,1)$. The probability that $M_n > t$ is:
\[
...
Let $M_n' = \max(X_1, \ldots, X_n)$ for i.i.d. $X_i \sim \text{Unif}(0,1)$. The cumulative distribution function is:
\[
...
The harmonic mean is $H_n = \frac{n}{\sum_{i=1}^n \frac{1}{X_i}}$. Let $Y_i = \frac{1}{X_i}$. Then:
\[
...
The geometric mean is $G_n = \left( \prod_{i=1}^n X_i \right)^{1/n}$. By the Fubini-Tonelli Theorem and independence:
\[
...
The arithmetic mean is $A_n = \frac{1}{n} \sum_{i=1}^n X_i$. By the SLLN:
\[
