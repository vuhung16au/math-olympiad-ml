...
% =============================================================================
\begin{problem}[Binomial Theorem Statement]
...
% =============================================================================
\begin{problem}[Partial Fraction Decomposition]
...
\begin{itemize}
    ...
    \item We first factor the polynomial completely to identify the structure of the integrand.
    \item Partial-fraction substitution can simplify high-degree rational integrands; using $u=x^2$ is a useful trick when even powers appear. 
    \item Recognise standard antiderivatives for quick evaluation.
    \item Try this technique on other rational functions with polynomial denominators. 
    
    $$J = \int \frac{1}{x^6 + x^4} \, dx$$
 \end{itemize}   
\end{takeaways}
...
% =============================================================================
\begin{problem}[System of Equations with Symmetric Polynomials]
...
% =============================================================================
\begin{problem}[Complex Roots of Quadratic]
...
% =============================================================================
\begin{problem}[Integer Solution to Polynomial Equation]
...
% =============================================================================
\begin{problem}[No Rational Roots via Parity Argument]
