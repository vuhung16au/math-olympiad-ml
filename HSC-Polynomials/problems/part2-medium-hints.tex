% Part 2: Medium Problems (14 problems with hints - upside-down format)
% Students attempt first, then rotate page 180° to read hint

% =============================================================================
% PROBLEM 13: Polynomial remainder with complex numbers
% =============================================================================
\begin{problem}[Polynomial Remainder with Complex Numbers]
...
\vspace{0.5cm}
\begin{hintbox}
(a) Compute $(-i)^2=-1, (-i)^3=i$. (b) $P(-i)$ equals remainder evaluated at $-i$: $6(-i)-3 = -3-6i$. Equate real/imaginary parts.
\end{hintbox}
...
% =============================================================================
\begin{problem}[De Moivre and Complex Equations]
\begin{enumerate}
...
\vspace{0.5cm}
\begin{hintbox}
(a) Rewrite $1 \pm i\tan\theta = \frac{\cos\theta \pm i\sin\theta}{\cos\theta}$, apply De Moivre. (b) Set $z=i\tan\theta$, equation becomes $\frac{2\cos 4\theta}{\cos^4\theta}=0$, so $\cos 4\theta=0$.
\end{hintbox}
...
% =============================================================================
\begin{problem}[Complex Cotangent Identity]
\begin{enumerate}
...
\vspace{0.5cm}
\begin{hintbox}
(a) Use half-angle formulas: $1+\cos\theta=2\cos^2(\theta/2)$, $\sin\theta=2\sin(\theta/2)\cos(\theta/2)$. (b) Set $w=(z-1)/(z+1)$, find $w^8=-1$, then $z=\frac{1+w}{1-w}$.
\end{hintbox}
...
% =============================================================================
\begin{problem}[Inequality Proof by Geometric Series]
...
\vspace{0.5cm}
\begin{hintbox}
Factor LHS as geometric series: $1 + b + b^2 + \dots + b^n$. Compare term-by-term with $\underbrace{1+1+\dots+1}_{n+1}$. Each $b^k < 1$ for $k \ge 1$.
\end{hintbox}
...
% =============================================================================
\begin{problem}[Induction with Symmetric Polynomial]
Prove by induction:
...
\vspace{0.5cm}
\begin{hintbox}
Base cases: $P(1)$: $x+1/x \ge 2$ (AM-GM); $P(2)$: $x^2+1+1/x^2 \ge 3$. Inductive step: $P(k) \implies P(k+2)$. Add $(x^{k+2}+1/x^{k+2}) \ge 2$.
\end{hintbox}
...
% =============================================================================
\begin{problem}[Divisibility via Fermat's Little Theorem]
Prove that $\frac{n^5}{5} + \frac{n^4}{2} + \frac{n^3}{3} - \frac{n}{30}$ is an integer for all integers $n \geq 1$.
\end{problem}

\vspace{0.5cm}
\begin{hintbox}
Combine over common denominator 30: $\frac{6n^5+15n^4+10n^3-n}{30} = \frac{n(6n^4+15n^3+10n^2-1)}{30}$. Show numerator divisible by 30 using Fermat's Little Theorem.
\end{hintbox}
...
% =============================================================================
\begin{problem}[Cubic with Constrained Roots]
Let $\alpha, \beta, \gamma$ be roots of $x^3 + Ax^2 + Bx + 8 = 0$ (where $A, B$ are real numbers).
...
\vspace{0.5cm}
\begin{hintbox}
(a) If $\beta$ non-real, conjugate must be root, but constraints force contradictions. (b) From $\alpha^2=-\beta^2<0$. (c) Let $\alpha=bi, \gamma=-bi, \beta=b$. Check product=$-8$ gives $b^2=-8$ (contradiction; typo in problem?).
\end{hintbox}
...
% =============================================================================
% PROBLEM 30: Even and odd coefficient sums
% =============================================================================
\begin{problem}[Even and Odd Coefficient Sums]
Consider a polynomial $P(x)$ written as $P(x) = E(x) + O(x)$, where $E(x)$ contains only even powers of $x$ and $O(x)$ contains only odd powers of $x$.
\begin{enumerate}
    \item[(i)] Show that $P(x)P(-x) = E(x)^2 - O(x)^2$.
    \item[(ii)] Explain why the difference between the squares of the sum of the even-powered coefficients and the sum of the odd-powered coefficients of $P(x)$ is $P(1)P(-1)$.
    \item[(iii)] Hence, for $(2x + \sqrt{5})^{2026}$, prove that this difference is exactly $1$.
\end{enumerate}
\end{problem}

\vspace{0.5cm}
\begin{hintbox}
(i) Use $P(-x)=E(x)-O(x)$. (ii) At $x=1$, $E(1)$ is the sum of even-powered coefficients and $O(1)$ is the sum of odd-powered coefficients. (iii) Evaluate $P(1)$ and $P(-1)$ and multiply.
\end{hintbox}

\begin{solution}
\textbf{(i)} Since $E(x)$ has only even powers, $E(-x)=E(x)$. Since $O(x)$ has only odd powers, $O(-x)=-O(x)$.
...
and hence
$$
P(x)P(-x)=(E(x)+O(x))(E(x)-O(x))=E(x)^2-O(x)^2.
$$

\textbf{(ii)} Let $S_e$ be the sum of the even-powered coefficients and $S_o$ be the sum of the odd-powered coefficients.

At $x=1$, we get $E(1)=S_e$ and $O(1)=S_o$, so
$$
P(1)=E(1)+O(1)=S_e+S_o,\qquad P(-1)=E(1)-O(1)=S_e-S_o.
$$
Therefore
$$
P(1)P(-1)=(S_e+S_o)(S_e-S_o)=S_e^2-S_o^2,
$$
which is the required difference.

\textbf{(iii)} Let $P(x)=(2x+\sqrt{5})^{2026}$. Then by part (ii) the required difference is
$$
P(1)P(-1).
$$
Now
$$
P(1)=(2+\sqrt{5})^{2026}, \qquad P(-1)=(\sqrt{5}-2)^{2026}.
$$
So
$$
P(1)P(-1)=\bigl((2+\sqrt{5})(\sqrt{5}-2)\bigr)^{2026}=(5-4)^{2026}=1^{2026}=1.
$$

\textbf{Answer:} The difference between the squares is $1$.
\end{solution}

\begin{takeaways}
Evaluating a polynomial at $x=1$ and $x=-1$ neatly separates even-powered and odd-powered coefficient sums.
\end{takeaways}

\vspace{1cm}

% =============================================================================
% PROBLEM 31: Conjugate root theorem
% =============================================================================
\begin{problem}[Conjugate Root Theorem]
\begin{enumerate}
...
\vspace{0.5cm}
\begin{hintbox}
(a) Take conjugate of $P(z)=0$: $\overline{P(z)}=\bar{0}=0$. Since coefficients real, $\overline{P(z)}=P(\bar{z})$. (b) If $z_1=1+2i$, then $z_2=1-2i$. Use sum of roots $=-(-6)/1=6$.
\end{hintbox}
...
% =============================================================================
% PROBLEM 32: Primitive roots of unity
% =============================================================================
\begin{problem}[Primitive Roots of Unity]
...
\begin{enumerate}
    ...
    \item If $\gcd(n,k)=h$, show $z_k$ primitive implies $h=1$. Here gcd is the greatest common divisor.
\end{enumerate}
\end{problem}

\vspace{0.5cm}
\begin{hintbox}
(a) $z_1^m = e^{2\pi im/n}$ gives all $n$ roots. (b) For $z^6=1$: $5m \bmod 6$ gives $5,4,3,2,1,0$. (c) $z_k^m=z_1^{km}$; generates all roots iff $\gcd(k,n)=1$.
\end{hintbox}
...
% =============================================================================
\begin{problem}[Infinite Geometric Series with Complex Terms]
...
\begin{enumerate}
    ...
    $$ \sum_{k=1}^{\infty} \sin k\alpha \cos^k \alpha = \cot \alpha $$
...
\vspace{0.5cm}
\begin{hintbox}
(a) $1-z\cos\alpha = \sin^2\alpha - i\sin\alpha\cos\alpha = \sin\alpha(\sin\alpha-i\cos\alpha)$. Rationalize. (b) Geometric series $=1+i\cot\alpha$; extract imaginary part.
\end{hintbox}
...
% =============================================================================
\begin{problem}[Bound on Polynomial Roots]
...
\vspace{0.5cm}
\begin{hintbox}
(a) $P(\beta)=0 \implies \beta^n = -(a_{n-1}\beta^{n-1}+\cdots+a_0)$. Triangle inequality: $|\beta|^n \le |a_{n-1}||\beta|^{n-1}+\cdots \le M(\cdots)$. (b) Assume $|\beta| \ge 1+M$, get contradiction.
\end{hintbox}
...
% =============================================================================
\begin{problem}[Weighted Sum of Roots of Unity]
...
\vspace{0.5cm}
\begin{hintbox}
(a) Let $S=1+2\omega+\cdots+n\omega^{n-1}$. Compute $S-\omega S$, use $\omega^n=1$ and given sum. (b) $z^n-1=(z-1)(z-\omega)\cdots(z-\omega^{n-1})$; evaluate at $z=1$.
\end{hintbox}
...
% =============================================================================
\begin{problem}[Factorization and Quadratic Formation]
\begin{enumerate}
...
\vspace{0.5cm}
\begin{hintbox}
(a) Fifth roots: $1, e^{2\pi i/5}, e^{4\pi i/5}, e^{-4\pi i/5}, e^{-2\pi i/5}$. Pair conjugates. (b) Divide by $z-1$, substitute $z=1$; or use $u=z+1/z$. (c) Solve $4x^2+2x-1=0$.
\end{hintbox}
