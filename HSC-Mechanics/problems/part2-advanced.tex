...
\begin{problem}[Shifted SHM center]
...
\end{takeaways}
\begin{problem}[Hyperbolic functions in mechanics]
...
\begin{problem}[Linear resistance form]
...
\begin{problem}[Quadratic resistance upward]
...
\begin{problem}[Horizontal quadratic resistance]
...
\begin{problem}[Linear resistance horizontal]
...
\begin{problem}[Inclined plane forces]
...
\begin{hint}
This appears to be a vectors problem rather than mechanics. Use projection or minimise the squared distance to find the perpendicular distance.
\end{hint}
...
\begin{problem}[SHM parameters from extremities]
...
\begin{problem}[Complex acceleration formula]
...
\begin{problem}[SHM with shifted center]
...
\begin{problem}[Trajectory equation application]
...
\begin{problem}[Quadratic in tan $\alpha$]
...
\begin{problem}[Inverse cube law]
...
\begin{problem}[Complex velocity function]
...
\begin{problem}[Cubic resistance]
...
\begin{problem}[Terminal velocity]
...
\begin{problem}[Exponential approach]
...
\begin{problem}[Component analysis]
...
\begin{problem}[Coefficient of restitution]
...
\begin{problem}[Upward projection]
...
\begin{problem}[Circular equations]
