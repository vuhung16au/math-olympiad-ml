...
\begin{problem}[Vector Force Equation]
...
\begin{enumerate}[label=(\roman*)]
    \item Use the information above to show that the initial velocity of the particle is $\vect{v}(0) = \begin{pmatrix} 20\sqrt{3} \\ 20 \end{pmatrix}$.
\end{enumerate}
...
The position vector of the particle, at time $t$ seconds after the particle is projected, is $\vect{r}(t)$ and the velocity vector is $\vect{v}(t)$.

\begin{enumerate}[label=(\roman*), resume]
    \item Show that $\vect{v}(t) = \begin{pmatrix} 20\sqrt{3}e^{-4t} \\[6pt] \dfrac{45}{2}e^{-4t} - \dfrac{5}{2} \end{pmatrix}$.
    
    \item Show that $\vect{r}(t) = \begin{pmatrix} 5\sqrt{3}\left(1 - e^{-4t}\right) \\[6pt] \dfrac{45}{8}\left(1 - e^{-4t}\right) - \dfrac{5}{2}t \end{pmatrix}$.
...
\[
\vect{v}(0) = \begin{pmatrix} 40 \cos 30^\circ \\ 40 \sin 30^\circ \end{pmatrix} = \begin{pmatrix} 40 \cdot \frac{\sqrt{3}}{2} \\ 40 \cdot \frac{1}{2} \end{pmatrix} = \begin{pmatrix} 20\sqrt{3} \\ 20 \end{pmatrix} \quad \text{(shown)}
\]

	extbf{(ii)} Newton's law with $m=1$, $g=10$, resistance $4\vect{v}$ gives $\dot{\vect{v}} = \begin{pmatrix} 0 \\ -10 \end{pmatrix} - 4\vect{v}$, so $\ddot{x} = -4\dot{x}$ and $\ddot{y} = -10 - 4\dot{y}$.
...
\[
\boxed{\vect{v}(t) = \begin{pmatrix} 20\sqrt{3}e^{-4t} \\[4pt] \frac{45}{2}e^{-4t} - \frac{5}{2} \end{pmatrix}} \quad \text{(shown)}
\]
...
\[
\boxed{\vect{r}(t) = \begin{pmatrix} 5\sqrt{3}(1 - e^{-4t}) \\[4pt] \frac{45}{8}(1 - e^{-4t}) - \frac{5}{2}t \end{pmatrix}} \quad \text{(shown)}
\]
...
\begin{takeaways}
\item \textbf{Vector Force Equation:} Air resistance $4\vect{v}$ opposes motion; Newton's law gives $\dot{\vect{v}} = \vect{g} - 4\vect{v}$ for unit mass
...
\begin{problem}[Quadratic Resistance Form]
...
\begin{problem}[Initial Velocity Components]
...
\begin{problem}[Identical Force Laws]
...
\begin{problem}[Combined Resistance]
