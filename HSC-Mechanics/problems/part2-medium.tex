...
\begin{solution}
$v\frac{dv}{dx} = 3x^2 \Rightarrow v\,dv = 3x^2\,dx$. Integrating: $\frac{v^2}{2} = x^3 + C$. At $x=1$, $v=2$: $2 = 1 + C \Rightarrow C = 1$. Thus $v^2 = 2x^3 + 2$. At $x=2$: $v^2 = 16 + 2 = 18 \Rightarrow v = 3\sqrt{2}$ m/s
\end{solution}
