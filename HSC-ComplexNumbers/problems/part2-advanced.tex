...
\textbf{Definition.} Every non-zero complex number $w = re^{i\theta}$ has two square roots. If $\theta$ is the principal argument of $w$ with $-\pi < \theta \le \pi$, the \textbf{principal square root} $\sqrt{w}$ is
\[
