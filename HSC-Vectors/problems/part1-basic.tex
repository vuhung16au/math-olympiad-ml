...
\end{align*}
\vspace{-3mm}
Thus: $\tfrac{\mathbf{a} \cdot \mathbf{b}}{\mathbf{b} \cdot \mathbf{b}} \mathbf{b} = \tfrac{-10}{20} \begin{pmatrix} 2 \\ 0 \\ -4 \end{pmatrix} = -\tfrac{1}{2} \begin{pmatrix} 2 \\ 0 \\ -4 \end{pmatrix} = \begin{pmatrix} -1 \\ 0 \\ 2 \end{pmatrix}$
\vspace{-2mm}
