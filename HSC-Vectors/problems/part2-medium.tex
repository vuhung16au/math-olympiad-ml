...
\begin{problem}[Direction Cosines — Compute and Verify]
Let $\mathbf{r} = 6\mathbf{i} + 2\mathbf{j} + 3\mathbf{k}$. The \textbf{direction cosines} of $\mathbf{r}$ are
\[
l = \cos\alpha, \quad m = \cos\beta, \quad n = \cos\gamma,
\]
where $\alpha$, $\beta$, and $\gamma$ are the angles between $\mathbf{r}$ and the positive $x$-, $y$-, and $z$-axes.

Find $l$, $m$, and $n$, and verify that $l^2 + m^2 + n^2 = 1$.
\end{problem}

\begin{hint}
First find $|\mathbf{r}|$, then use $l = \dfrac{6}{|\mathbf{r}|}$, $m = \dfrac{2}{|\mathbf{r}|}$, $n = \dfrac{3}{|\mathbf{r}|}$ (see the direction-cosines proof in Problem~3.9).
\end{hint}
...
\[
l = \frac{6}{7}, \qquad m = \frac{2}{7}, \qquad n = \frac{3}{7}.
\]
...
So the direction cosines are $\left(\dfrac{6}{7}, \dfrac{2}{7}, \dfrac{3}{7}\right)$, and they satisfy $l^2 + m^2 + n^2 = 1$ as expected from Problem~3.9.
\end{solution}
