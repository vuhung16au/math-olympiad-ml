...
Two lines intersect and are perpendicular. \\
Find values of $p$ and $q$ for the line $\mathbf{r} = \begin{pmatrix} 1 \\ 0 \\ p \end{pmatrix} + \lambda \begin{pmatrix} 2 \\ q \\ -1 \end{pmatrix}$.
\end{problem}
