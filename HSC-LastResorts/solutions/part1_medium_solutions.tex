...
(i) Let $\vec{AB} = (-a,b,0)$ and $\vec{AC} = (-a,0,c)$. If $\theta$ is the angle between these two sides of the triangle, then
\[
S = \frac12 |\vec{AB}|\,|\vec{AC}|\sin\theta.
\]
Using $\cos\theta = \dfrac{\vec{AB}\cdot\vec{AC}}{|\vec{AB}|\,|\vec{AC}|}$, we obtain
\[
4S^2 = |\vec{AB}|^2 |\vec{AC}|^2 - (\vec{AB}\cdot\vec{AC})^2.
\]
Now
\[
|\vec{AB}|^2 = a^2+b^2,\quad |\vec{AC}|^2 = a^2+c^2,\quad \vec{AB}\cdot\vec{AC}=a^2,
\]
so
\[
4S^2 = (a^2+b^2)(a^2+c^2)-a^4 = a^2b^2+a^2c^2+b^2c^2.
\]
Hence
\[
S = \frac{1}{2} \sqrt{b^2 c^2 + a^2 c^2 + a^2 b^2}.
\]
...
Takeaway: Dot products and projections are powerful tools in 3D geometry.
