...
(i) $\vec{AB} = (-a, b, 0)$ and $\vec{AC} = (-a, 0, c)$. Using
\[
...
so
\[
S = \frac{1}{2} \sqrt{b^2c^2 + a^2c^2 + a^2b^2}.
\]

Takeaway: Dot-product identities are powerful for area calculations in 3D geometry.
