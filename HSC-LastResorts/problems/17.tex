...
\begin{itemize}
    ...
    \item Since $1 \neq 0$, the swap failed. This is because $\{f_n\}$ does not converge uniformly. The maximum value of $f_n(x)$ occurs at $x = \frac{1}{n+1}$, where $f_n(\frac{1}{n+1}) \approx \frac{n}{e}$, which tends to $\infty$. Thus, no $N$ can be found that works for all $x$ simultaneously.
\end{itemize}
