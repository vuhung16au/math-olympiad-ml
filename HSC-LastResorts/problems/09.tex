...
A simple pendulum of length $l$ is released from rest at the horizontal position 
($\theta=\tfrac{\pi}{2}$). 
Let $\theta$ be the angle the pendulum makes with the downward vertical. 
...
\]
With $\sin(\theta/2)=\tfrac{1}{\sqrt2}\sin\phi$, we have $\cos\theta = 1 - 2\sin^2(\theta/2) = 1 - \sin^2\phi = \cos^2\phi$.
Differentiating the substitution gives $\frac{1}{2}\cos\left(\frac{\theta}{2}\right) d\theta = \frac{1}{\sqrt{2}}\cos\phi \, d\phi$. 
Since $\cos\left(\frac{\theta}{2}\right) = \sqrt{1 - \sin^2\left(\frac{\theta}{2}\right)} = \sqrt{1 - \frac{1}{2}\sin^2\phi}$, we rearrange to find:
