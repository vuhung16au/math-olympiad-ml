...
Consider a sequence of rectangular prisms with a square base of side length $a_n$ and height $b_n$. The first prism has $a_1=1$ and $b_1=2$. For integers $n\ge1$ define
\[
a_{n+1}=\frac{2a_n+b_n}{3},\qquad b_{n+1}=\frac{2}{a_{n+1}^2}.
\]

\begin{enumerate}[label=(\roman*)]
    \item Show that every prism in the sequence has volume $2$.
    \item Prove that $a_n\ge\sqrt[3]{2}$ for all $n\ge2$.
    \item Show by induction that for $n\ge2$,
...
\]
so $V_n\equiv2$ for all $n$.

	\textbf{(ii)} By AM--GM applied to $a_n, a_n, b_n$:
\[a_{n+1}=\frac{a_n+a_n+b_n}{3}\ge\sqrt[3]{a_n^2 b_n}=\sqrt[3]{2}.\]
Since $a_1^2 b_1=2$, we have $a_2\ge\sqrt[3]{2}$. By induction, $a_n\ge\sqrt[3]{2}$ for all $n\ge2$.
...
\]
By induction, $a_n-\sqrt[3]{2}\le\frac{1}{3^{n-2}}(a_2-\sqrt[3]{2})$ for $n\ge2$.
