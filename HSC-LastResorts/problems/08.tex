...
\item By using the substitution $\sin \theta = \frac{2b \sin \phi}{(a+b) + (a-b)\sin^2 \phi}$, show that
...
&=\int_0^{\pi/2}\frac{d\theta}{\sqrt{a^2\sin^2\theta+b^2\cos^2\theta}}
\end{align*}
To match the exact definition of $I(a,b)$, use the complementary angle substitution $\alpha = \frac{\pi}{2} - \theta \implies d\theta = -d\alpha$. The limits $0$ to $\frac{\pi}{2}$ become $\frac{\pi}{2}$ to $0$, and sine and cosine swap:
\begin{align*}
&= \int_{\pi/2}^0 \frac{-d\alpha}{\sqrt{a^2\sin^2(\frac{\pi}{2} - \alpha)+b^2\cos^2(\frac{\pi}{2} - \alpha)}} \\
&= \int_0^{\pi/2} \frac{d\alpha}{\sqrt{a^2\cos^2\alpha+b^2\sin^2\alpha}} = I(a,b).
\end{align*}
