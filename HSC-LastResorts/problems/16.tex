...
\textbf{(a)(iii)} By part (ii), each term is less than $10^{-9}$ times the previous one, so the tail is negligible. In particular, the $n=1$ term affects only about the $9$th or $10$th decimal place. Hence $S_0$ alone already gives at least $6$ correct decimal places for $1/\pi$.
