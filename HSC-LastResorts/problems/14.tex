...
In this problem, we will prove that $\pi^2$ is irrational using a proof by contradiction inspired by Niven's approach. You may already know that $\pi$ itself is irrational yet the proof is somewhat not straightforward.
