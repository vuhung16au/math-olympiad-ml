...
Proving the irrationality of $\pi^2$ makes the statement stronger, since if $\pi^2$ were irrational, then $\pi$ would also be rational (as the square root of a rational number) (do NOT prove this). Thus, by proving that $\pi^2$ is irrational, we also confirm the irrationality of $\pi$.
