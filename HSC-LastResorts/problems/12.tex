...
\[ \lim_{n \to \infty} \sqrt{n} W_n = \sqrt{\pi/2}. 
...
\begin{itemize}
   ...
   \item \textbf{(iii)} 
   $I_{left} = \int_0^{\pi/2} (1-\sin^2\theta)^n \sqrt{n}\cos\theta \, d\theta = \sqrt{n} \int_0^{\pi/2} \cos^{2n+1}\theta \, d\theta = \sqrt{n}W_{2n+1}$ (since $\int_0^{\pi/2} \cos^m \theta \, d\theta = \int_0^{\pi/2} \sin^m \theta \, d\theta = W_m$ by symmetry). $I_{right} = \int_0^{\pi/2} (\sec^2\theta)^{-n} \sqrt{n}\sec^2\theta \, d\theta = \sqrt{n}W_{2n-2}$.
