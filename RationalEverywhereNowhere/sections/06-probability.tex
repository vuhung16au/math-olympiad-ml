...
\begin{tikzpicture}[scale=1.2]
    ...
    \node[above] at (5, 0.5) {Interval $[a, b]$};
    ...
    \node[below] at (5, -1.4) {Probability distribution: uniform over $[a, b]$};
    
    % Rationals probability
    \draw[thick, bookred, fill=bookred!10] (4.8, -1) rectangle (5.2, -0.5);
    \node[below] at (5, -1.8) {Rationals: measure = 0, probability = 0};
    
    % Irrationals probability
    \draw[thick, bookpurple, fill=bookpurple!30] (0, -1) rectangle (10, -0.5);
    \node[below] at (5, -2.2) {Irrationals: measure = $b-a$, probability = 1};
\end{tikzpicture}
...
\begin{tikzpicture}[scale=1]
    ...
    \draw[fill=bookred!10] (5, 0) circle (0.15);
    \node at (5, 0) {\scriptsize \textbf{0\%}};
    \node[below] at (5, -0.6) {Rational Numbers};
    
    % Arrow
    \draw[->, thick, bookred] (0.2, 0) -- (4.8, 0);
    \node[above] at (2.5, 0.5) {Negligible};
\end{tikzpicture}
