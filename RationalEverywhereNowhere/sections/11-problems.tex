...
\begin{solutionbox}
Define $f: \mathbb{N} \to \mathbb{Z}$ by $f(1) = 0$ and for $n > 1$, $f(n) = (-1)^n \lfloor n/2 \rfloor$. This gives a bijection.
\end{solutionbox}
...
\begin{solutionbox}
If $A = \{a_1, a_2, \ldots, a_n\}$, cover each $a_i$ with interval $I_i = [a_i - \frac{\epsilon}{2n}, a_i + \frac{\epsilon}{2n}]$. Then $\mu(\bigcup I_i) \leq n \cdot \frac{\epsilon}{n} = \epsilon$. Since $\epsilon$ is arbitrary, $\mu(A) = 0$.
\end{solutionbox}
