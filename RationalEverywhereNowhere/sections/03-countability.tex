...
\begin{tikzpicture}[scale=1]
    ...
    \node[above] at (4, 3.5) {Much larger!};
\end{tikzpicture}
...
\begin{tikzpicture}[scale=0.9]
    ...
    \node[above] at (5.7, 1.6) {Move guest};
    \node[above] at (5.7, 1.3) {from room $n$};
    \node[above] at (5.7, 1.0) {to room $2n$};
...
\begin{tikzpicture}[scale=0.85]
    ...
    \node[above] at (0.5, 1.6) {Day 1};
    \node[above] at (0.5, 2.0) {written};
    ...
    \node[above] at (3, 2.6) {Days 1-2};
    \node[above] at (3, 3.0) {written};
    ...
    \node[above] at (5.5, 3.6) {Days 1-3};
    \node[above] at (5.5, 4.0) {written};
    ...
    \node[above] at (8, 4.6) {Days 1-$n$};
    \node[above] at (8, 5.0) {written};
