...
\begin{tikzpicture}[scale=1.5]
    ...
    \node[above] at (2.236, 0.3) {$\sqrt{5} \approx 2.236$};
    
    % Rational approximations
    \draw[fill=bookpurple] (2, 0) circle (1.5pt);
    \node[below] at (2, -0.3) {$\frac{2}{1}$};
    \draw[fill=bookpurple] (2.25, 0) circle (1.5pt);
    \node[below] at (2.25, -0.3) {$\frac{9}{4}$};
    \draw[fill=bookpurple] (2.2, 0) circle (1.5pt);
    \node[below] at (2.2, -0.3) {$\frac{11}{5}$};
    
    % Error bars
    \draw[thick, bookred, <->] (2, -0.6) -- (2.236, -0.6);
    \node[below] at (2.118, -0.8) {error};
    
    \node[below] at (3, -1.0) {Rational approximations to $\sqrt{5}$};
\end{tikzpicture}
