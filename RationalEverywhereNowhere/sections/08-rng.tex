...
\begin{tikzpicture}[scale=1]
    ...
    \node[below] at (5, -0.6) {Weak keys (countable, measure zero)};
    
    % Measure indicator
    \draw[thick, bookpurple, <->] (0, -1.2) -- (10, -1.2);
    \node[below] at (5, -1.4) {Total keyspace measure};
    
    \draw[thick, bookred, <->] (4.9, -1.8) -- (5.1, -1.8);
    \node[below] at (5, -2.0) {Weak keys measure = 0};
\end{tikzpicture}
